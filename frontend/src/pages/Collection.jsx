  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
        ...
        <div className={`border border-blue-400 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
...
{/* SubCategory Filters */}
<div className={`border border-blue-400 pl-5 py-3 my-5 ${showFilter ? '' : 'hidden'} sm:block`}>
          <p className='mb-3 text-sm font-medium text-blue-600'> TYPE</p>
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            <p className='flex gap-2'>
...
{/* right */}
    <div className='flex-1'>
      ...
      {/* Product sort */}
      <select onChange={(e)=>setSortType(e.target.value)} className='border-2 border-blue-400 text-sm px-2'>
