...
const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='flex gap-2 mt-2'>
        <input onChange={()=> setTrending(prev => !prev)} checked={trending} type="checkbox" name="" id="trending" />
        <label className='cursor-pointer' htmlFor="trending">Add to trending</label>
      </div>

      <ButtonLoading 
        className='w-28 py-3 mt-4 bg-blue-800 text-white hover:bg-blue-900 transition-colors' 
        type="submit"
